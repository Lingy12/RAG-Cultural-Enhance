...
python src/evaluator.py /home/shared_LLMs/gemma-2b-it prompt/prompt_eval.txt ./vector_store/wiki_filter_country_bge-large-en-v1.5 0.4 64 "sg_eval,us_eval,ph_eval" embed BAAI/bge-large-en-v1.5 --verbose 0 --need_rerank --rerank_sample 8
